/**
 * Секция «Процесс». Часть текстов у оригинала записана дважды: широкий вариант
 * для планшета и десктопа и узкий для мобильного, где формулировка короче или
 * перенос стоит в другом месте.
 */
export type ProcessStep = {
  image: string
  /** Отдельные файлы под узкие экраны, если картинку перекадрировали. */
  imageTablet?: string
  imageMobile?: string
  name: string
  nameMobile: string
