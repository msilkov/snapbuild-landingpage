/** Секция «Безопасность»: три пункта, у каждого свой кадр. */
export const security = {
  title: 'Безопасность без компромиссов',
  points: [
    {
      image: 'security-approved-models.webp',
      imageMobile: 'security-approved-models-mobile-v2.jpg',
      title: 'Только одобренные модели',
      desc: 'Работаем только с российскими и локализованными моделями, без экспортных ограничений',
    },
    {
      image: 'security-private-cloud.webp',
      imageMobile: 'security-private-cloud-mobile-v2.jpg',
    ...
    {
      image: 'security-ai-stack.webp',
      imageMobile: 'security-ai-stack-mobile-v2.jpg',
